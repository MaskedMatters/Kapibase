    ...
    <ul class="menu bg-base-200 rounded-box w-full">
        <li>
            <a href="/home/tools">
                ...
                <span class="{page.url.pathname == "/home/tools" ? "font-bold" : ""}">My Tools</span>
            </a>
        </li>
        <li>
            <a href="/home">
                ...
                <span class="{page.url.pathname == "/home" ? "font-bold" : ""}">Home</span>
            </a>
        </li>
        <li>
            <a href="/home/events">
                ...
                <span class="{page.url.pathname == "/home/events" ? "font-bold" : ""}">Events</span>
            </a>
        </li>
        <li>
            <a href="/home/groups">
                ...
                <span class="{page.url.pathname == "/home/groups" ? "font-bold" : ""}">Groups</span>
            </a>
        </li>
        <li>
            <button>
